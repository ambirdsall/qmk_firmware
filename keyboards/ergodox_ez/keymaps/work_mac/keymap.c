...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox_pretty(
    ...
    KC_LSHIFT,         MEDIA(KC_Z),  KC_X,           SYM(KC_C),    ARR(KC_V),    KC_B,     SPACEHAMMER,      /**/    SPACEHAMMER,      KC_N,      ARR(KC_M),    SYM(KC_COMMA),KC_DOT,       MEDIA(KC_SLASH),   KC_RSHIFT,
  ...
  [2] = LAYOUT_ergodox_pretty(
    KC_TRNS,           ALT_T(KC_1),  ALT_T(KC_2),    ALT_T(KC_3),  ALT_T(KC_4),  ALT_T(KC_5),KC_TRNS,        /**/    KC_TRNS,        ALT_T(KC_6), ALT_T(KC_7), ALT_T(KC_8), ALT_T(KC_9),   KC_F3,          ALT_T(KC_BSPACE),
