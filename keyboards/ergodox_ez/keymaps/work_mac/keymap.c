...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox_pretty(
    ...
    LCTL_T(KC_ESCAPE),KC_A,           KC_S,           KC_D,           KC_F,           KC_G,                                                                           KC_H,           KC_J,           KC_K,           KC_L,           LT(3,KC_SCOLON),LGUI_T(KC_QUOTE),
    KC_LSHIFT,      LCTL_T(KC_Z),   KC_X,           KC_C,           KC_V,           KC_B,           LCTL(LGUI(KC_LALT)),                                LCTL(LGUI(KC_LALT)),KC_N,           KC_M,           KC_COMMA,       KC_DOT,         RCTL_T(KC_SLASH),KC_RSHIFT,
    LT(3,KC_GRAVE), WEBUSB_PAIR,    LALT(KC_LSHIFT),KC_LGUI,        LT(2,KC_NO),                                                                                                    LT(1,KC_NO),    KC_DOWN,        KC_LBRACKET,    KC_RBRACKET,    MO(1),
                                                                                                    LALT_T(KC_LEFT),KC_RIGHT,       KC_DOWN,        LCTL_T(KC_UP),
                                                                                                                    KC_END,         KC_PGUP,
                                                                                    LGUI_T(KC_SPACE),LCTL_T(KC_ESCAPE),LALT_T(KC_MINUS),RALT_T(KC_EQUAL),RCTL_T(KC_ESCAPE),RGUI_T(KC_ENTER)
  ),
